tinymce.init({
    ...
    external_filemanager_path: _base_url+"/public/filemanager/",
    external_plugins: { "filemanager" : _base_url + "/public/filemanager/plugin.min.js"},
});
...
tinymce.init({
	...
	toolbar1: "bold italic underline alignleft aligncenter alignright alignjustify bullist numlist | outdent indent blockquote link unlink anchor forecolor backcolor code",
	image_advtab: true,
	menubar: false,
...
$('#select_img').click(function(){
    ...
    $('#modal-file').on('hide.bs.modal',function(){
        ...
        document.getElementById('show_img').src=_base_url+_img;
