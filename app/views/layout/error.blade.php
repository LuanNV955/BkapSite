...
<head>
  ...
  <!-- base:css -->
  <link rel="stylesheet" href="{{url('public/backend')}}/vendors/typicons/typicons.css">
          ...
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="{{route('backend.index')}}">Back to home</a>
              </div>
            </div>
            <div class="row mt-5">
